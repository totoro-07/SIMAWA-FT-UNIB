...
<body>
    ...
    <nav class="navbar navbar-expand-lg navbar-dark" id="nav_menu">
        <div class="container">
            <a class="navbar-brand logo" href="{{ url('/') }}">SIMAWA</a>
            <button class="navbar-toggler toggle_btn" type="button" id="toggle_btn">
        ...
        <div class="container">
            <div class="row align-items-center">
                <div class="col-md-6 grid-item-1">
                    ...
                    <p class="info-text">
                        Portal terpadu untuk mengelola Prestasi, Beasiswa, dan Kegiatan Mahasiswa Fakultas Teknik
                        Universitas Bengkulu.
                    </p>

                    <div class="btn_wrapper">
                        <a href="{{ route('account.register') }}" class="btn view_more_btn">
                            Daftar Sekarang <i class="fas fa-arrow-right"></i>
                        </a>
                        <a href="{{ route('account.login') }}" class="btn documentation_btn">Login</a>
                    </div>
                </div>
        ...
        <div class="container">
            ...
            <div class="row g-4">
                ...
                <div class="col-md-4">
                    <div class="news-card">
                        <div class="news-img">
                            <img src="{{ asset('storage/'.$item->image) }}" alt="{{ $item->judul }}" class="img-fluid">
                            <div class="news-date">
                        ...
                        <div class="news-content">
                            ...
                            @if ($item->link)
                            <a href="{{ $item->link }}" class="news-btn" target="_blank">Lihat Selengkapnya <i
                    ...
                    <div class="container" style="max-width: 95%;">
                        ...
                        <div class="row justify-content-center" style="padding: 0px">
                            ...
                            <div class="col-md-3 text-center">
                                ...
                                <iframe width="100%" height="180px" class="embed-responsive-item"
                                    src="https://www.youtube.com/embed/oCPINaBHscw?si=YhPgJYauwSM5Gxio"
                                    allowfullscreen=""></iframe>
